...
class UNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=4):
        """
        in_channels : Anzahl der Input-Kanäle (RGB=3)
        out_channels: Anzahl der Segmentierungsklassen (hier 4: background, text, curve, grid)
        """
    ...
    def forward(self, x):
        ...
        # Output-Logits (ohne Sigmoid/Softmax)
        return self.conv_last(d1)  # Shape: [B, 4, H, W]
